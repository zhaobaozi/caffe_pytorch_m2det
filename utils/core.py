...
def set_optimizer(net, cfg):
   # print(net.Conv2d-597)
    #print "hahahahha"
    loc0_params = list(map(id, net.loc2[0].parameters()))
    loc1_params = list(map(id, net.loc2[1].parameters()))
    loc2_params = list(map(id, net.loc2[2].parameters()))
    loc3_params = list(map(id, net.loc2[3].parameters()))
    loc4_params = list(map(id, net.loc2[4].parameters()))
    loc5_params = list(map(id, net.loc2[5].parameters()))
    conf0_params = list(map(id, net.conf2[0].parameters()))
    conf1_params = list(map(id, net.conf2[1].parameters()))
    conf2_params = list(map(id, net.conf2[2].parameters()))
    conf3_params = list(map(id, net.conf2[3].parameters()))
    conf4_params = list(map(id, net.conf2[4].parameters()))
    conf5_params = list(map(id, net.conf2[5].parameters()))
   ...
   # print "hahahah" 
    ...
    return optim.SGD([
    {'params': base_params,'lr': cfg.train_cfg.lr[0]*0.1}, {'params':net.loc2[0].parameters()},
                                  {'params': net.loc2[1].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.loc2[2].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.loc2[3].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.loc2[4].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.loc2[5].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.conf2[0].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.conf2[1].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.conf2[2].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.conf2[3].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.conf2[4].parameters(), 'lr': cfg.train_cfg.lr[0] },
                                  {'params': net.conf2[5].parameters(), 'lr': cfg.train_cfg.lr[0] }],lr = cfg.train_cfg.lr[0]*0.1,momentum = cfg.optimizer.momentum,weight_decay = cfg.optimizer.weight_decay)
